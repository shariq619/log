    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.tdp.list.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <input type="text" id="name" disabled placeholder="{{ auth()->user()->name }}" value="{{ $logList->name }}" name="name" class="form-control">
                    </div>
                    <div class="col">
                        <input type="text" id="license_no" placeholder="License No./Coupe No" name="license_no"
                               class="form-control" value="{{ $logList->license_no }}" disabled>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col">
                ...
                <div class="row mt-5">
                    <div class="col">
                        <select name="land_status" id="land_status" class="form-control" disabled>
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reduced_impact_logging" id="reducedRadio1"
                                       value="yes" <?php echo ($logList->reduced_impact_logging == "yes") ? 'checked="checked"' : '';?> disabled> Yes
                                <span class="circle">
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reduced_impact_logging" id="reducedRadio2"
                                       value="no" <?php echo ($logList->reduced_impact_logging == "no") ? 'checked="checked"' : '';?> disabled> No
                                <span class="circle">
                                    <span class="check"></span>
                                </span>
                            </label>
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="market" id="markettRadio1"
                                       value="export_processing" <?php echo ($logList->market == "export_processing") ? 'checked="checked"' : '';?> disabled> Export processing
                                <span class="circle">
                                    <span class="check"></span>
                                </span>
                            </label>
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="market" id="markettRadio2"
                                       value="local_processing" <?php echo ($logList->market == "local_processing") ? 'checked="checked"' : '';?> disabled> Local processing
                                <span class="circle">
                                    <span class="check"></span>
                                </span>
                            </label>
                ...
                <div class="row mt-5">
                    <div class="col">
                        <input type="text" id="name_of_scaler" placeholder="Name of Scaler" name="name_of_scaler" class="form-control"
                               value="{{ $logList->name_of_scaler }}" disabled>
                    </div>
                    <div class="col">
                        ...
                        <input type="file" id="registered_property_hammer_mark"  name="registered_property_hammer_mark"
                               class="form-control" value="{{ $logList->registered_property_hammer_mark }}" disabled>
                    </div>
                    <div class="col">
                        <input type="text" id="owner_of_property_hammer_mark" placeholder="Owner of Property Hammer Mark" name="owner_of_property_hammer_mark"
                               class="form-control" value="{{ $logList->owner_of_property_hammer_mark }}" disabled>
                    </div>
                </div>
                ...
                <table id="logs_table" class="table">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <input type="text" id="serial_no" placeholder="Serial No" name="serial_no[]" value="{{$logs->serial_no}}" class="form-control" disabled>
                        </td>
                        <td>
                            <input type="text" id="log_no" placeholder="Log  No" name="log_no[]"
                               class="form-control"  value="{{$logs->log_no}}"disabled>
                        </td>
                        <td>
                            <select name="species[]" id="species" class="form-control" disabled>
                        ...
                        <td>
                            <input type="text" id="length" placeholder="Length" name="length[]" class="form-control" value="{{$logs->length}}"  disabled>
                        </td>
                        <td>
                            <input type="text" id="diameter_1" placeholder="Diameter 1" name="diameter_1[]" class="form-control" value="{{$logs->diameter_1}}"  disabled>
                        </td>
                        <td>
                            <input type="text" id="diameter_2" placeholder="Diameter 2" name="diameter_2[]" class="form-control" value="{{$logs->diameter_2}}" disabled>
                        </td>
                        <td>
                            <input type="text" id="diameter_mean" placeholder="Diameter Mean" name="diameter_mean[]" class="form-control"  value="{{$logs->diameter_mean}}" disabled>
                        </td>
                        <td>
                            <input type="text" id="symbol" placeholder="Symbol " name="symbol[]" class="form-control" value="{{$logs->symbol}}" disabled>
                        </td>
                        <td>
                            <input type="text" id="defect_length" placeholder="Defect Length" name="defect_length[]" class="form-control" value="{{$logs->defect_length}}" disabled>
                        </td>
                        <td>
                            <input type="text" id="defect_diameter" placeholder="Defect Diameter" name="defect_diameter[]" class="form-control" value="{{$logs->defect_diameter}}" disabled>
                        </td>
                        </tr>
                        @endforeach
                    </tbody>
